...
pce_core_mom = sa_main(core_pce_sa, titulo="PCE - Core")
pce_core_ya = anualizar(core_pce_sa, titulo="PCE - Core", ylim=(0, 0.07))
...
pce_goods_mom = sa_main(cpi_core_goods, titulo="PCE - Goods")
pce_goods_ya = anualizar(cpi_core_goods, titulo="PCE - Goods", ylim=(-0.02, 0.06))
...
pce_serv_mom = sa_main(cpi_core_services, titulo="PCE - Services")
pce_serv_ya = anualizar(cpi_core_services, titulo="PCE - Services", ylim=(0.005, 0.08))
...
pce_food_mom = sa_main(cpi_food, titulo="PCE - Food")
pce_food_yoy = anualizar(cpi_food, titulo="PCE - Food", ylim=(-0.01, 0.08))
...
pce_en_mom = sa_main(cpi_energy, titulo="PCE - Energy")
pce_en_ya = anualizar(cpi_energy, titulo="PCE - Energy", ylim=(-0.3, 0.5))
...
pce_ndur_mom = sa_main(pce_nondurable, titulo="PCE - Non-Durable Goods")
pce_ndur_yoy = anualizar(pce_nondurable, titulo="PCE - Non-Durable Goods", ylim=(-0.04, 0.08))
...
pce_durable_mom = sa_main(pce_durable, titulo="PCE - Durable Goods")
pce_durable_yoy = anualizar(pce_durable, titulo="PCE - Durable Goods", ylim=(-0.04, 0.08))
